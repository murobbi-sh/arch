...
| [Boot-GRUB.md](./Boot-GRUB.md) | Setup bootloader GRUB untuk UEFI, termasuk catatan dual boot |
| [Boot-UKI.md](./Boot-UKI.md) | Setup boot dengan UKI, cocok untuk sistem modern dan Secure Boot |
| [Setup-btrfs.md](./Setup-btrfs.md) | Setup Btrfs, subvolume, Snapper, snapshot, dan rollback |
...
Baca: [Setup-btrfs.md](./Setup-btrfs.md)
